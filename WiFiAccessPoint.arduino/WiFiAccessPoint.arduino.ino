      ...
      if (client.available()) {     // if there's bytes to read from the client,
        ...
        if (c == '\n') {            // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            client.print("Click <a href=\"/led1_H\">here</a> to turn ON the LED.<br>");
            client.print("Click <a href=\"/led1_L\">here</a> to turn OFF the LED.<br>");
            client.print("Click <a href=\"/led2_H\">here</a> to turn ON the LED.<br>");
            client.print("Click <a href=\"/led2_L\">here</a> to turn OFF the LED.<br>");
